...
const { createProductsTable, createRecipeDetailsTable, createFranchiseProductsTable, createChefFoodTable, createSubscriptionPlansTable, createUserFoodCartTable } = require('./src/config/migrations');
