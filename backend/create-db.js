...
async function createDatabaseAndTables() {
  ...
  await connection.execute("ALTER TABLE `delivery_partners` ADD COLUMN IF NOT EXISTS `current_address` VARCHAR(512)");
  await connection.execute("ALTER TABLE `delivery_partners` ADD COLUMN IF NOT EXISTS `permanent_address` VARCHAR(512)");
  await connection.execute("ALTER TABLE `delivery_partners` ADD COLUMN IF NOT EXISTS `live_location` VARCHAR(512)");
  await connection.execute("ALTER TABLE `delivery_partners` ADD COLUMN IF NOT EXISTS `emergency_contact_name` VARCHAR(255)");
  await connection.execute("ALTER TABLE `delivery_partners` ADD COLUMN IF NOT EXISTS `emergency_contact_relationship` VARCHAR(50)");
  await connection.execute("ALTER TABLE `delivery_partners` ADD COLUMN IF NOT EXISTS `emergency_contact_mobile` VARCHAR(50)");
  ...
  await connection.execute("ALTER TABLE `delivery_partners` ADD COLUMN IF NOT EXISTS `selfie_with_vehicle` VARCHAR(255)");
  await connection.execute("ALTER TABLE `delivery_partners` ADD COLUMN IF NOT EXISTS `selfie_with_aadhaar` VARCHAR(255)");
