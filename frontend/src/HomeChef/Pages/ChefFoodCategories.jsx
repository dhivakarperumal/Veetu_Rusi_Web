...
const ChefFoodCategories = () => {
  ...
  const fetchCategories = async () => {
    try {
      ...
      console.error('Failed loading chef food categories', err);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (editId) {
        await api.put(`/chef-food-categories/${editId}`, payload);
  ...
  const handleDelete = async (cat) => {
    ...
    try {
      await api.delete(`/chef-food-categories/${cat.catId || cat.id}`);
...
export default ChefFoodCategories;
