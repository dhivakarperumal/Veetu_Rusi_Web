  ...
  return (
    <div className="admin-root min-h-screen bg-[#040b0a] text-slate-100">
      ...
      >
        ...
        <main className="relative flex-1 overflow-y-auto bg-gradient-to-b from-[#020806] via-[#06110f] to-[#040a08] px-3 py-4 sm:px-5 lg:px-6">
          ...
          <div className="relative w-full overflow-hidden rounded-xl sm:rounded-2xl border border-white/10 bg-[#08120f]/90 backdrop-blur-2xl shadow-[0_40px_120px_rgba(0,0,0,0.45)] p-6 sm:p-8 min-h-[calc(100vh-170px)]">
