                ...
                return uniqueThumbs.map((img, index) => {
                  ...
                  return (
                    <img
                      ...
                      className={`w-14 h-14 sm:w-18 sm:h-20 sm:h-16 object-cover object-top rounded-lg cursor-pointer border ${selectedImage === resolvedImg ? "border-primary" : "border-gray-200"
                        }`}
                    />
                  );
                });
