      ...
      <PageContainer>
        ...
        {loading ? (
          ...
          >
            {[1, 2, 3, 4, 5, 6].map((i) => (
              <SwiperSlide key={i}>
                <div className="flex flex-col items-center animate-pulse pb-5">
                  <div className="w-28 h-28 md:w-36 md:h-36 rounded-full bg-gray-100"></div>
                  <div className="mt-5 w-24 h-8 bg-gray-100 rounded-full"></div>
                </div>
              </SwiperSlide>
            ))}
          </Swiper>
